#!/usr/bin/env python3
"""
Recuperation des codes promo easyJet depuis shopilo.fr
Sursa: https://shopilo.fr/reductions/easyjet.com
"""
...
SHOPILO_URL = "https://shopilo.fr/reductions/easyjet.com"
STORE_NAME = "easyJet"


def fetch_coupons(url=SHOPILO_URL):
    """Renvoie la liste des coupons actifs pour easyJet depuis shopilo.fr"""
    headers = {
        "User-Agent": "Mozilla/5.0 (compatible; coupon-fetcher/1.0; +https://github.com/shopilo-fr/code-promo-easyjet)"
    }
    try:
